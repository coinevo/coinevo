...
gsigs = 'https://github.com/coinevo/gitian.sigs.git'
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/coinevo/coinevo', help='Specify the URL of the repository. Default is %(default)s')
